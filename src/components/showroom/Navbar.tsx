...
export function Navbar() {
  ...
  <div className="absolute left-0 top-full mt-2 min-w-44 rounded-2xl border border-line/70 bg-card/95 p-3 opacity-0 pointer-events-none shadow-premium transition-opacity duration-150 group-hover:opacity-100 group-hover:pointer-events-auto group-focus-within:opacity-100 group-focus-within:pointer-events-auto">
    ...
    <header className="sticky top-0 z-40 border-b border-line/70 bg-background/78 backdrop-blur-xl">
      <div className="container flex min-h-20 items-center gap-4 py-3">
        <Link to="/" className="mr-2 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-red-500 text-sm text-white font-bold">EV</div>
          <div>
            <p className="font-display text-lg">EV</p>
